...
public class Salle {
    ...
    public Salle(String nom, Categorie categorie,Integer capacite) {
        this.nom = nom;
    ...
    public boolean estDisponible(LocalDateTime debut, LocalDateTime fin) {
        for (Reservation reservation : reservations) {
            boolean chevauchement = !(fin.isBefore(reservation.getDateDebut()) || debut.isAfter(reservation.getDateFin()));
            if (chevauchement) {
                return false;
            }
        }
